...
public class AgenciaDao {
    ...
    public Agencia buscarAgenciaPorCodigoAgencia(String codigo_agencia) {
    ...
    public static void main(String[] args) {
       ...
       // System.out.println("Teste loop buscar todas agencias");
        ...
        var a = agenciaDao.buscarAgenciaPorCodigoAgencia("0001");
        System.out.println("ID= "+ a.getCodigoAgencia() + " Nome= "+ a.getCidade());
    }
}
//trazer a agencia pelo codigo da agencia
